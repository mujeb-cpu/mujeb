  ...
  if (!draft) {
    return (
      <div className="flex flex-col items-center gap-4 py-20 text-center">
        ...
        <Button variant="outline" onClick={() => navigate("/app/policies")}>Back to policies</Button>
      </div>
    );
  }
      ...
      {published ? (
        <Card className="border-eligible/30 bg-eligible-muted">
          <CardContent className="flex flex-col items-center gap-4 py-12 text-center">
            ...
            <div className="flex gap-2">
              <Button variant="outline" onClick={() => navigate("/app/policies")}>View policies</Button>
              <Button onClick={() => navigate("/app")}>Go to overview</Button>
            </div>
          </CardContent>
        </Card>
      ) : (
        <>
          ...
          <div className="flex justify-end gap-2">
            <Button variant="outline" onClick={() => navigate("/app/policies")}>Cancel</Button>
